...
namespace Tonic
{
	...
	public:
		...
		FPSComponent(Tonic::GameObject* parent, const std::shared_ptr<TextComponent>& pTextComp);

		//Adds a new text component using the given font, and sets a pointer to that text component
		FPSComponent(Tonic::GameObject* parent, const std::shared_ptr<Tonic::Font>& font);
