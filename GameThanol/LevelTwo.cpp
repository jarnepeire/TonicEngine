...
void LevelTwo::Initialize()
{
	...
	//Disks
	AddDiskToGrid(hexGridComp, HexCoordinate(1, 0), movingDiskSoundId);
	AddDiskToGrid(hexGridComp, HexCoordinate(4, 1), movingDiskSoundId);
	AddDiskToGrid(hexGridComp, HexCoordinate(1, 4), movingDiskSoundId);
