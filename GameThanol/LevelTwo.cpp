...
LevelTwo::LevelTwo(const std::string& name)
	: QBertScene(name, L"../Data/QBert/Levels/LevelTwo.json")
{
}
...
void LevelTwo::Initialize()
{
	...
	auto pLevelText = pLevelUI->AddComponent<TextComponent>(std::make_shared<TextComponent>("Level: 2", qBertSmallFont));
...
void LevelTwo::FixedUpdate(float)
{
}

void LevelTwo::Update(float)
{
}
